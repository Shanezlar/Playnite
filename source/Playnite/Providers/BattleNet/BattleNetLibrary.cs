    ...
    public class BattleNetLibrary : IBattleNetLibrary
    {
        ...
        public static readonly List<BNetApp> BattleNetProducts = new List<BNetApp>()
        {
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//fab/a25ed0ddd3225929bc3ad5139ebc7483-prod-card-tall.jpg",
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//fbd/bafaafcfb7c6c620067662a04409ba66-prod-card-tall.jpg",
                Name = "Diablo III",
                Type = BNetAppType.Default,
                Links = new List<Link>()
                {
                    new Link("Homepage", "https://www.diablo3.com"),
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//fd8/18fb5862b6d5aea418ad4102ed48aa63-prod-card-tall.jpg",
                Name = "StarCraft II",
                Type = BNetAppType.Default,
                Links = new List<Link>()
                {
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//f95/6d9453be1750dbf035f0ee574cff2c25-prod-card-tall.jpg",
                Name = "StarCraft",
                Type = BNetAppType.Default,
                Links = new List<Link>()
                {
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//f89/c074270c5024a5bb627d46cddf024dad-prod-card-tall.jpg",
                Name = "Hearthstone",
                Type = BNetAppType.Default,
                Links = new List<Link>()
                {
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//f8c/0f2efeb8d64127edb647a95c236c92ba-prod-card-tall.jpg",
                Name = "Heroes of the Storm",
                Type = BNetAppType.Default,
                Links = new List<Link>()
                {
                    new Link("Homepage", "https://www.heroesofthestorm.com"),
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//4c/c358d897f1348281ed0b21ea2027059b-prod-card-tall.jpg",
                Name = "Overwatch",
                Type = BNetAppType.Default,
                Links = new List<Link>()
                {
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//f84/7d453e354c9df8ca335ad45da020704c-prod-card-tall.jpg",
                Name = "Destiny 2",
                Type = BNetAppType.Default,
                Links = new List<Link>()
                {
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//7f/a31777e05911989e7839ea02435c9eb5-prod-card-tall.jpg",
                Name = "Diablo II",
                Type = BNetAppType.Classic,
                ClassicExecutable = "Diablo II.exe",
                Links = new List<Link>()
                {
                    new Link("Homepage", "https://blizzard.com/games/d2/"),
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//4/cb3a7d551cb3524c5a8c68abacd4fda9-prod-card-tall.jpg",
            ...
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//42/a4e5b0ccd23d09ad34e7c0a074bb4c11-prod-card-tall.jpg",
                Name = "Warcraft III: Reign of Chaos",
                Type = BNetAppType.Classic,
                ClassicExecutable = "Warcraft III Launcher.exe",
                Links = new List<Link>()
                {
                    new Link("Homepage", "https://blizzard.com/games/war3/"),
                    new Link("Forums", "https://us.battle.net/forums/en/bnet/12790218/")
                }
            },
            new BNetApp()
            {
                ...
                CoverUrl = "https://bnetproduct-a.akamaihd.net//fd9/a4b9e92295e20508bb62a0756577e925-prod-card-tall.jpg",
